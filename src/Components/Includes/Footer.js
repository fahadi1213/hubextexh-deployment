...
const Footer = () => {
    ...
    const apiEmailPostingHandler = async () => {
        const baseURL = "https://17d1-72-255-21-77.ngrok.io/api/v1/leads";
    ...
    const postingDataHandler = () => {
        apiEmailPostingHandler().then(response => {
            swal("Thank you!", "Our team will contact you within 24 hours", "success");
        }).catch(err => {
